from app import app
from .api.device import register_device,get_credentials,authenticate_device,get_device_list,close_session
...
app.add_url_rule('/close','close_session',close_session,methods=['POST'])
